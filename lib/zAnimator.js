...
exports.default = function (options) {
      ...
      circle.getWidth = function () {
            console.log('circle width: ' + this.circleShape.radius * this.scale * 2);
